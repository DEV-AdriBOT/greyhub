...
export default async function OrdersPage({
  ...
  searchParams: Promise<{ status?: string; team?: string; error?: string }>;
}) {
  ...
  if (query.team && allowedTeams.includes(query.team)) {
    clauses.push("orders.team_type = ?");
    ...
    <>
      <div className="page-heading heading-with-action">
        <div>
          ...
          <h1>Orders</h1>
          <p>Claim open work or ask an existing crew to let you in.</p>
        </div>
        {manager && (
                  ...
                  <tr key={order.id}>
                    ...
                    <td>
                      <div className="crew-cell">
                        ...
                        <span>
                          {order.worker_count}/{order.max_workers} ·{" "}
                          {titleCase(order.team_type)}
                        </span>
                      </div>
                    </td>
